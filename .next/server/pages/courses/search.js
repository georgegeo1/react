...
Index.getInitialProps = async ctx => {
  ...
  const response = await axios__WEBPACK_IMPORTED_MODULE_3___default().get(url, payload); // console.log(response)
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,4198,6485], () => (__webpack_exec__(4569)));
