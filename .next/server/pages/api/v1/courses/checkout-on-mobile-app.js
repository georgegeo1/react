...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res) => {
  ...
  try {
    const {
      userId
    } = jsonwebtoken__WEBPACK_IMPORTED_MODULE_0___default().verify(req.headers.authorization, "bjdggfuqgkjsnjbcjhadybd");
...
var __webpack_exports__ = __webpack_require__.X(0, [4206], () => (__webpack_exec__(234)));
